...
def train_epoch():
    ...
    for i, data in enumerate(train_loader):
        ...
        cham_loss_compl.backward(retain_graph=True)
        optimizer.step()
        ...
        cham_loss_incom.backward(retain_graph=True)
        optimizer.step()
        ...
        cham_loss_sparse.backward(retain_graph=True)
        optimizer.step()
        ...
        cham_loss_very_sparse.backward(retain_graph=True)
        optimizer.step()
        ...
        cham_loss_very_very_sparse.backward(retain_graph=True)
        optimizer.step()
...
os.system('cp PointClout_seeds_version_curriculum.py '+output_folder+'/'+'main_code.py.backup')
