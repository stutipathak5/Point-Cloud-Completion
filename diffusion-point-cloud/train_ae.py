...
# Check the type of train_dset
print(f"Type of train_dset: {type(train_dset)}")

# Check the length of the dataset if it has a __len__ method
if hasattr(train_dset, '__len__'):
