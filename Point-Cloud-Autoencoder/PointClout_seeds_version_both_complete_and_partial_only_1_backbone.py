...
parser.add_argument('--batch_size',   type=int,   default=126,          help='size of minibatch used during training')
...
def train_epoch():
    ...
    for i, data in enumerate(train_loader):
        ...
        cham_loss = (cham_loss_compl+ cham_loss_incom + cham_loss_sparse + cham_loss_very_sparse)/3
        cham_loss_comp = (cham_loss_sparse_comp + cham_loss_very_sparse_comp )/2
