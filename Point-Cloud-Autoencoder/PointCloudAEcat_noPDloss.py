...
# %%
batch_size = 32
output_folder = "output/Dutch_easy_no_pdloss/" # folder path to save the results
...
static_persistence  = (load_pickle).astype(np.float32)[3::4]   #add - assuming that  laoding gives as list --> the [3::4] gives every 4th element
# pdb.set_trace()
