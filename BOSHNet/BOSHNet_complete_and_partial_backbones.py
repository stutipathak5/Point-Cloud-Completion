...
def train_epoch():
    ...
    for i, data in enumerate(train_loader):
        ...
        # pdb.set_trace()
        cham_loss_incom, _ = chamfer_distance(complete_data, output_incom.permute(0,2,1),norm=1)
        cham_loss_compl, _ = chamfer_distance(complete_data, output_compl.permute(0,2,1),norm=1)

        cham_loss_sparse, _ = chamfer_distance(complete_data, output_spars.permute(0,2,1),norm=1)
        cham_loss_very_sparse, _ = chamfer_distance(complete_data, output_very_spars.permute(0,2,1),norm=1)
        cham_loss_very_very_sparse, _ = chamfer_distance(complete_data, output_very_very_spars.permute(0,2,1),norm=1)
        cham_loss_very_very__very_sparse, _ = chamfer_distance(complete_data, output_very_very_very_spars.permute(0,2,1),norm=1)
        cham_loss_very_very__very_very_sparse, _ = chamfer_distance(complete_data, output_very_very_very_very_spars.permute(0,2,1),norm=1)
        ...
        cham_loss_sparse_comp, _ = chamfer_distance(complete_data, output_spars_comp.permute(0,2,1),norm=1)
        cham_loss_very_sparse_comp, _ = chamfer_distance(complete_data, output_very_spars_comp.permute(0,2,1),norm=1)
        cham_loss_very_very_sparse_comp, _ = chamfer_distance(complete_data, output_very_very_spars_comp.permute(0,2,1),norm=1)
        cham_loss_very_very__very_sparse_comp, _ = chamfer_distance(complete_data, output_very_very_very_very_spars_comp.permute(0,2,1),norm=1)
        cham_loss_very_very__very_very_sparse_comp, _ = chamfer_distance(complete_data, output_very_very_very_very_spars_comp.permute(0,2,1),norm=1)
...
def test_batch(data): # test with a batch of inputs
    with torch.no_grad():
        ...
        loss, _ = chamfer_distance(complete_data, output.permute(0,2,1),norm=1) 
...
dynamic_lidar = normalize(np.load('/home/scratch/prashant/martini-scratch2/temp/scratch2/prashant/completion/completion/data_ours/data_ours/difficult/test/partial.npy')).astype(np.float32)
static_lidar  = normalize(np.load('/home/scratch/prashant/martini-scratch2/temp/scratch2/prashant/completion/completion/data_ours/data_ours/difficult/test/complete.npy')).astype(np.float32)
